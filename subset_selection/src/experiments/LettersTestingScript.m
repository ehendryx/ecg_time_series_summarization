...
load test_letter_recognition_data.mat
...
param = [6 2 8 10; 18 2 8 10 ; 3 2 12 14; 15 2 10 16; 16 2 4 6; 20 2 12 14]
for row = 1:6
...
TempTable = [num2cell(OutputMatrix) key' repmat({"Test"},27,1) repmat(alg(algorithm),27,1) repmat({num2str(tol)},27,1)];
...
savename = strcat("Letters_Test.csv")
